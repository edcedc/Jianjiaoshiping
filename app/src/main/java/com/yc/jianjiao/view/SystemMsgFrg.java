...
import com.yc.jianjiao.adapter.SystemMsgAdapter;
...
public class SystemMsgFrg extends BaseFragment<CommentPresenter, BNotTitleRecyclerBinding> implements CommentContract.View{
    ...
    protected void initView(View view) {
        if (adapter == null) {
            adapter = new SystemMsgAdapter(act, this, listBean);
        }
