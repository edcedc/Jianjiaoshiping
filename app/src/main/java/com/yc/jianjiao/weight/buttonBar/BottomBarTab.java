package com.yc.jianjiao.weight.buttonBar;
...
public class BottomBarTab extends FrameLayout {
    ...
    public BottomBarTab(Context context, String url, CharSequence title) {
        super(context);
        this.init(context, 0, url, title);
    }
    ...
    public BottomBarTab(Context context, AttributeSet attrs, int defStyleAttr, int icon, CharSequence title) {
        ...
        init(context, icon, null, title);
    }

    private void init(Context context, int icon, String url, CharSequence title) {
        mContext = context;
...
//        GlideLoadingUtils.load(context, CloudApi.SERVLET_URL + url, mIcon);
...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_gray));
    ...
    public void setSelected(boolean selected) {
        ...
        switch (mTabPosition){
            case 0:
                mIcon.setImageResource(selected? R.mipmap.icon_a01 : R.mipmap.icon_a06);
                break;
            case 1:
                mIcon.setImageResource(selected? R.mipmap.icon_a07 : R.mipmap.icon_a02);
                break;
            case 2:
                mIcon.setImageResource(selected? R.mipmap.icon_a08 : R.mipmap.icon_a03);
                break;
            case 3:
                mIcon.setImageResource(selected? R.mipmap.icon_a09 : R.mipmap.icon_a04);
                break;
            case 4:
                mIcon.setImageResource(selected? R.mipmap.icon_a10 : R.mipmap.icon_a05);
                break;
        }
        if (selected) {
//            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.orange_FF7D2D));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.orange_FF7D2D));
        } else {
