...
public class HomeChildList2Adapter extends BaseListViewAdapter<DataBean> {
    public HomeChildList2Adapter(Context act, List<DataBean> listBean) {
        super(act, listBean);
    }
    public HomeChildList2Adapter(Context act, BaseFragment root, List<DataBean> listBean) {
    ...
    protected View getCreateVieww(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(act, R.layout.i_worth, null);
