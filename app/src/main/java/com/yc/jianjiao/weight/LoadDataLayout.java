...
public class LoadDataLayout extends FrameLayout implements View.OnClickListener {
    ...
    public LoadDataLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.ganxin.library.R.styleable.LoadDataLayout);

        builder.setLoadingText(TextUtils.isEmpty(typedArray.getString(com.ganxin.library.R.styleable.LoadDataLayout_loadingText)) ? builder.loadingText : typedArray.getString(com.ganxin.library.R.styleable.LoadDataLayout_loadingText));
        builder.setLoadingTextColor(typedArray.getResourceId(com.ganxin.library.R.styleable.LoadDataLayout_loadingTextColor, builder.loadingTextColor));
        builder.setLoadingTextSize(typedArray.getInteger(com.ganxin.library.R.styleable.LoadDataLayout_loadingTextSize, builder.loadingTextSize));
        builder.setLoadingViewLayoutId(typedArray.getResourceId(com.ganxin.library.R.styleable.LoadDataLayout_loadingViewLayoutId, builder.loadingViewLayoutId));

        builder.setEmptyText(TextUtils.isEmpty(typedArray.getString(com.ganxin.library.R.styleable.LoadDataLayout_emptyText)) ? builder.emptyText : typedArray.getString(com.ganxin.library.R.styleable.LoadDataLayout_emptyText));
        builder.setEmptyImgId(typedArray.getResourceId(com.ganxin.library.R.styleable.LoadDataLayout_emptyImgId, builder.emptyImgId));
        builder.setEmptyImageVisible(typedArray.getBoolean(com.ganxin.library.R.styleable.LoadDataLayout_emptyImageVisible, builder.emptyImageVisible));

        builder.setErrorText(TextUtils.isEmpty(typedArray.getString(com.ganxin.library.R.styleable.LoadDataLayout_errorText)) ? builder.errorText : typedArray.getString(com.ganxin.library.R.styleable.LoadDataLayout_errorText));
        builder.setErrorImgId(typedArray.getResourceId(com.ganxin.library.R.styleable.LoadDataLayout_errorImgId, builder.errorImgId));
        builder.setErrorImageVisible(typedArray.getBoolean(com.ganxin.library.R.styleable.LoadDataLayout_errorImageVisible, builder.errorImageVisible));

        builder.setNoNetWorkText(TextUtils.isEmpty(typedArray.getString(com.ganxin.library.R.styleable.LoadDataLayout_noNetWorkText)) ? builder.noNetWorkText : typedArray.getString(com.ganxin.library.R.styleable.LoadDataLayout_noNetWorkText));
        builder.setNoNetWorkImgId(typedArray.getResourceId(com.ganxin.library.R.styleable.LoadDataLayout_noNetWorkImgId, builder.noNetWorkImgId));
        builder.setNoNetWorkImageVisible(typedArray.getBoolean(com.ganxin.library.R.styleable.LoadDataLayout_noNetWorkImageVisible, builder.noNetWorkImageVisible));

        builder.setAllPageBackgroundColor(typedArray.getResourceId(com.ganxin.library.R.styleable.LoadDataLayout_allPageBackgroundColor, builder.allPageBackgroundColor));
        builder.setAllTipTextSize(typedArray.getInteger(com.ganxin.library.R.styleable.LoadDataLayout_allTipTextSize, builder.allTipTextSize));
        builder.setAllTipTextColor(typedArray.getResourceId(com.ganxin.library.R.styleable.LoadDataLayout_allTipTextColor, builder.allTipTextColor));

        builder.setReloadBtnText(TextUtils.isEmpty(typedArray.getString(com.ganxin.library.R.styleable.LoadDataLayout_reloadBtnText)) ? builder.reloadBtnText : typedArray.getString(com.ganxin.library.R.styleable.LoadDataLayout_reloadBtnText));
        builder.setReloadBtnTextSize(typedArray.getInteger(com.ganxin.library.R.styleable.LoadDataLayout_reloadBtnTextSize, builder.reloadBtnTextSize));
        builder.setReloadBtnTextColor(typedArray.getResourceId(com.ganxin.library.R.styleable.LoadDataLayout_reloadBtnTextColor, builder.reloadBtnTextColor));
        builder.setReloadBtnBackgroundResource(typedArray.getResourceId(com.ganxin.library.R.styleable.LoadDataLayout_reloadBtnBackgroundResource, builder.reloadBtnBackgroundResource));
        builder.setReloadBtnVisible(typedArray.getBoolean(com.ganxin.library.R.styleable.LoadDataLayout_reloadBtnVisible, builder.reloadBtnVisible));
        builder.setReloadClickAreaType(typedArray.getInt(com.ganxin.library.R.styleable.LoadDataLayout_reloadClickArea, builder.reloadClickArea));
    ...
    private void build() {
        ...
        if (builder.loadingViewLayoutId != NO_ID) {
            ...
            loadingView = LayoutInflater.from(mContext).inflate(com.ganxin.library.R.layout.widget_loading_view, null);
        }
        emptyView = LayoutInflater.from(mContext).inflate(com.ganxin.library.R.layout.widget_empty_view, null);
        errorView = LayoutInflater.from(mContext).inflate(com.ganxin.library.R.layout.widget_error_view, null);
        noNetworkView = LayoutInflater.from(mContext).inflate(com.ganxin.library.R.layout.widget_no_network_view, null);

        //findView
        emptyLayout = (LinearLayout) emptyView.findViewById(com.ganxin.library.R.id.empty_layout);
        errorLayout = (LinearLayout) errorView.findViewById(com.ganxin.library.R.id.error_layout);
        noNetWorkLayout = (LinearLayout) noNetworkView.findViewById(com.ganxin.library.R.id.no_network_layout);

        emptyImg = (ImageView) emptyView.findViewById(com.ganxin.library.R.id.empty_img);
        errorImg = (ImageView) errorView.findViewById(com.ganxin.library.R.id.error_img);
        noNetworkImg = (ImageView) noNetworkView.findViewById(com.ganxin.library.R.id.no_network_img);

        loadingTv = (TextView) loadingView.findViewById(com.ganxin.library.R.id.loading_text);
        emptyTv = (TextView) emptyView.findViewById(com.ganxin.library.R.id.empty_text);
        errorTv = (TextView) errorView.findViewById(com.ganxin.library.R.id.error_text);
        noNetworkTv = (TextView) noNetworkView.findViewById(com.ganxin.library.R.id.no_network_text);

        emptyReloadBtn = (TextView) emptyView.findViewById(com.ganxin.library.R.id.empty_reload_btn);
        errorReloadBtn = (TextView) errorView.findViewById(com.ganxin.library.R.id.error_reload_btn);
        noNetWorkReloadBtn = (TextView) noNetworkView.findViewById(com.ganxin.library.R.id.no_network_reload_btn);
    ...
    public void onClick(View view) {
        ...
        int i = view.getId();
        if (i == com.ganxin.library.R.id.empty_layout
                || i == com.ganxin.library.R.id.empty_reload_btn
                || i == com.ganxin.library.R.id.error_layout
                || i == com.ganxin.library.R.id.error_reload_btn
                || i == com.ganxin.library.R.id.no_network_layout
                || i == com.ganxin.library.R.id.no_network_reload_btn) {
    ...
    public static class Builder {
        ...
        int emptyImgId = com.ganxin.library.R.drawable.ic_empty;
        int errorImgId = com.ganxin.library.R.drawable.ic_error;
        int noNetWorkImgId = com.ganxin.library.R.drawable.ic_no_network;
        ...
        int allPageBackgroundColor = com.ganxin.library.R.color.pageBackground;
        int allTipTextColor = com.ganxin.library.R.color.text_color_child;
        int allTipTextSize = 16;
        int loadingTextSize = 16;
        int loadingTextColor = com.ganxin.library.R.color.text_color_theme;
        int reloadBtnTextSize = 16;
        int reloadBtnTextColor = com.ganxin.library.R.color.colorPrimary;
