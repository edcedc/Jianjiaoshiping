...
public class HomeChildPresenter extends HomeChildContract.Presenter{
    ...
    @Override
    public void onDramaticRequest(String id) {
        CloudApi.videoPageLabelType(id, 2)
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(Disposable disposable) throws Exception {
                    }
    ...
    public void onLabel(String id) {
        CloudApi.labelListHomeClassifyRecommend(id)
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(Disposable disposable) throws Exception {
                    }
    ...
    @Override
    public void onScreen(final String id) {
        CloudApi.labelListFiltrate(id)
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(Disposable disposable) throws Exception {
                    }
