...
public class CommunicationQQAdapter extends BaseListViewAdapter<DataBean>{
    public CommunicationQQAdapter(Context act, List<DataBean> listBean) {
        super(act, listBean);
    }
    ...
    protected View getCreateVieww(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(act, R.layout.i_qq, null);
