...
public class CommunicationPresenter extends CommunicationContract.Presenter{
    @Override
    public void onRequestQQ() {
        CloudApi.flockList(0)
