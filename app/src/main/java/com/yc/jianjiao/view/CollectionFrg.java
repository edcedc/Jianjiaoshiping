...
public class CollectionFrg extends BaseFragment<CollectionPresenter, FHistoricalBinding> implements CollectionContract.View, View.OnClickListener{
        ...
        switch (view.getId()){
            ...
            case R.id.tv_clear:
                ...
                for (int i = 0; i < listBean.size(); i++) {
                    ...
                    if (bean.isSelect()){
                        temp.add(bean);
                        listStr.add(bean.getVideo_collect_id());
                    }
                }
