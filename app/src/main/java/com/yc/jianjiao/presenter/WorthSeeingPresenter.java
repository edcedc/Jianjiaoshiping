...
public class WorthSeeingPresenter extends WorthSeeingContract.Presenter{

    @Override
    public void onRequest(int pagerNumber, List<String> id) {
        CloudApi.videoPageSecondaryLabel(id, pagerNumber)
                ...
                .subscribe(new Observer<Response<BaseResponseBean<BaseListBean<DataBean>>>>() {
                    ...
                    public void onNext(Response<BaseResponseBean<BaseListBean<DataBean>>> baseResponseBeanResponse) {
                        if (baseResponseBeanResponse.body().code == Code.CODE_SUCCESS){
                            ...
                            mView.setData(new ArrayList<DataBean>());
                            mView.hideLoading();
