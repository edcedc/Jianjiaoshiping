...
import com.yc.jianjiao.weight.BiliDanmukuParser;
...
public class SelectedTwoPresenter extends SelectedTwoContract.Presenter{

    @Override
    public void onLookRequest(String id) {
        CloudApi.videoPageLabelType(id, 1)
    ...
    @Override
    public void onClassRequest(String id) {
        CloudApi.videoPageLabelType(id, 4)
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(Disposable disposable) throws Exception {
                    }
    ...
    @Override
    public void onLikeRequest(String id) {
        CloudApi.videoPageLabelType(id, 3)
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(Disposable disposable) throws Exception {
                    }
    ...
    @Override
    public BaseDanmakuParser reateParser(InputStream stream) {
        if (stream == null) {
    ...
    @Override
    public void onScreenSave(final String text) {
        CloudApi.screenSave(text)
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(Disposable disposable) throws Exception {
                    }
    ...
    @Override
    public void onLabelImg() {
        CloudApi.labelListBigHandsomeGuyLabel()
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(Disposable disposable) throws Exception {
                    }
